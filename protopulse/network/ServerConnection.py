...
from protopulse.network.messages.ConnectedMessage import ConnectedMessage
from protopulse.network.messages.ConnectionProcessCrashedMessage import \
...
class ServerConnection(mp.Thread):
    ...
    def onClose(self, err) -> None:
        ...
        from protopulse.network.messages.ServerConnectionClosedMessage import \
    ...
    def onConnectionTimeout(self) -> None:
        from protopulse.network.messages.ServerConnectionFailedMessage import \
